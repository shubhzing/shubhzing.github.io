...
var url= ''
    xhr.open('POST',"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+latitude+","+longitude+"&radius=10000&types=hospital&key=AIzaSyDIH6VyEfL8bbFi5F5Srn5r3pFfYFyPpf0", true)
    //call the onload 
    xhr.onload = function() 
        {
